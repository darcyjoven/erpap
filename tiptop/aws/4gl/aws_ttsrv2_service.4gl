...
#             LET l_op = com.WebOperation.CreateDOCStyle("aws_getDelivery", p_op_name, g_request, g_response)
    ...
    #杂收单查询 	cws_get_aimt302
      ...
      #darcy:2024/01/23 add e---
      #darcy:2024/05/10 add s---
      WHEN "cws_CreateAsfi514"
         let l_op =com.WebOperation.CreateDOCStyle("cws_CreateAsfi514", p_op_name, g_request, g_response)
      #darcy:2024/05/10 add e---
      #darcy:2024/05/29 add s---
      when "cws_CreatePOMJ"
         let l_op =com.WebOperation.CreateDOCStyle("cws_CreatePOMJ", p_op_name, g_request, g_response)
      #darcy:2024/05/29 add e---
      #darcy:2024/06/24 add s---
...
#darcy:2022/10/18 e---
#darcy:2023/05/08 add s---
function cws_checkputset()
   let g_service = "CheckPutSet"
   call cws_check_put_set()
end function
#darcy:2023/05/08 add e---
{#生成报工单
...
#darcy:2024/01/23 add s---
function cws_Createtc_pmm()
   let g_service = "CheckSubDTS"
   call cws_create_tc_pmm()
end function
#darcy:2024/01/23 add e---
function cws_CreateAsfi514()
   let g_service = "CreateAsfi514"
   call cws_create_asfi514()
end function
#darcy:2024/05/10 add s---
...
#darcy:2024/05/29 add s---
function cws_CreatePOMJ()
   let g_service = "CreatePOMJ"
   call cws_create_pomj()
end function
#darcy:2024/05/29 add e---


#darcy:2024/06/24 add s---
function cws_CreateAsft623()
   let g_service = "CreateAsft623"
