...
function p_email_config_show()
    select 
     ...
     into 
        g_tc_mae.tc_mae01,g_tc_mae.tc_mae02,g_tc_mae.tc_mae03,g_tc_mae.tc_mae04,_tc_mae.tc_mae05,
        g_tc_mae.tc_mae06,g_tc_mae.tc_mae07,g_tc_mae.tc_mae08,g_tc_mae.tc_mae09,g_tc_mae.tc_mae10,
        g_tc_mae.tc_mae11,g_tc_mae.tc_mae12,g_tc_mae.tc_mae13,g_tc_mae.tc_mae14,g_tc_mae.tc_mae15,g_tc_mae.tc_mae16,g_tc_mae.tc_mae17,g_tc_mae.tc_mae18,g_tc_mae.tc_mae19,g_tc_mae.tc_mae20,
...
function p_email_config_u()
    message ""
    call cl_opmsg("u")
    let g_forupd_sql = "select *  from tc_mae for update " 
    ...
    open tc_mae_curl
    if sqlca.sqlcode then
        call cl_err("opne cursor",sqlca.sqlcode,1)
        return
    end if
