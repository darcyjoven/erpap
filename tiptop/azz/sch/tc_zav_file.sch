...
grant select on tc_zav_file to tiptopgp;
grant update on tc_zav_file to tiptopgp;
grant delete on tc_zav_file to tiptopgp;
grant insert on tc_zav_file to tiptopgp;
grant index on tc_zav_file to public;
grant select on tc_zav_file to ods;
