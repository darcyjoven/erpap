...
MAIN
   ...
   OPEN WINDOW q461_w WITH FORM "axc/42f/axcq463"
...
DEFINE l_sql,l_sql1 STRING 
   ...
   LET l_sql = "select ima01,ima02,ima021,imk02,imk03,imd02,ima25,sum(qcsl),0,sum(qcje),sum(rksl),0,sum(rkje),sum(cksl),0,sum(ckje),sum(qmsl),0,sum(qmje) ",
"   from ima_file left join ",
" (select imk01,imk02,imk03,sum(imk09) qcsl,sum(imk09*ccc23) qcje,0 rksl,0 rkje,0 cksl,0 ckje,0 qmsl,0 qmje ",
...
"  group by imk01,imk02,imk03 ",
" union all ",
" select imk01,imk02,imk03,0 qcsl,0 qcje,0 rksl,0 rkje,0 cksl,0 ckje,sum(imk09) qmsl,sum(imk09*ccc23) qmje ",
"   from imk_file,ccc_file ",
"  where imk01 = ccc01 and imk05 = ccc02 and imk06 = ccc03 ",
...
" group by ccb01 ",
" union all ",
" select imk01,imk02,imk03,sum(imk09) qcsl,0 qcje,0 rksl,0 rkje,0 cksl,0 ckje,0 qmsl,0 qmje ",
"   from imk_file ",
"  where imk05 = ",tm.ey," and imk06 = ",tm.em, 
"    and imk02 in (select jce02 from jce_file) ",
"  group by imk01,imk02,imk03 ",
" union all ",
" select imk01,imk02,imk03,0 qcsl,0 qcje,0 rksl,0 rkje,0 cksl,0 ckje,sum(imk09) qmsl,0 qmje ",
"   from imk_file ",
"  where imk05 = ",tm.ey," and imk06 = ",tm.em,
"   and imk02 in (select jce02 from jce_file) ",
"  group by imk01,imk02,imk03 ",
...
"  group by ima01,ima02,ima021,imk02,imk03,imd02,ima25 "
