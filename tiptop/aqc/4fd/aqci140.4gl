   ...
   WHILE TRUE
      ...
      CASE g_action_choice
         ...
         WHEN "check_material"          #add by hlf07751
            ...
            LET imaud04 = 'Y'
           INPUT BY NAME g_ima.imaud03,g_ima.imaud04 WITHOUT DEFAULTS
           AFTER FIELD (imaud03)
           IF imaud04='N' THEN
           CALL cl_err(g_prog ,'hlf03',0)
           NEXT FIELD imaud04
...
DEFINE
    ...
    LET g_forupd_sql =
      " SELECT pmh02,'',pmh21,pmh05,pmh06,pmh08,pmh09,pmh15,pmh16,'' ",                  #CHI-8C0017
      "   FROM pmh_file ",
      "   WHERE pmh01= ? ",
      "    AND pmh02= ? ",
...
DEFINE
    ...
    LET g_sql =
       "SELECT DISTINCT pmh02,pmc03,pmh21,pmh05,pmh06,pmh08,pmh09,pmh15,pmh16 ",            #CHI-8C0017   #CHI-BB0007 add DISTINCT
