               ...
               IF NOT cl_null(g_qcs.qcs01) THEN
                     ...
                     select unique qctt01,qctt02,qctt021 into l_qcs01,l_qcs02,l_qcs05
                      from qcs_file a ,qctt_file,qcs_file b
                              where a.qcs01= g_qcs.qcs01 and a.qcs02 =g_qcs.qcs02 and a.qcs05=g_qcs.qcs05
       ...
       #darcy:2023/05/22 add s---
        when 'measure_append'
            if cl_chk_act_auth() then
                ...
                #  无测量值的时候才能修改
                let l_cnt = 0
                select count(1) into l_cnt from qctt_file
                 where qctt01 = g_qcs.qcs01 and qctt02 = g_qcs.qcs02 and qctt021 = g_qcs.qcs05
                if l_cnt > 0 then
                  call cl_err('','cqc-007',1)
                else
                  #darcy:2023/07/03 add s---
                  # 增加单头允许修改
                  call cl_set_comp_entry("qcs021,qcs04,qcs041,qcs21,qcs16,qcsud12,qcs03",false)
                  call t110_u()
                  #darcy:2023/07/03 add s---
                  call t110_b()
                  call cl_set_comp_entry("qcs021,qcs04,qcs041,qcs21,qcs16,qcsud12,qcs03",true) #darcy:2023/07/03
                  let g_action_choice = ''
                end if
...
FUNCTION t110_u()
   ...
   WHILE TRUE
      ...
      if g_qcs.qcsud01 != g_qcs_t.qcsud01 then
         update qcs_file set qcsud01 = g_qcs.qcsud01
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
            continue while
         end if
      end if
      if g_qcs.qcsud03 != g_qcs_t.qcsud03 then
         update qcs_file set qcsud03 = g_qcs.qcsud03
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
      ...
      if g_qcs.qcsud04 != g_qcs_t.qcsud04 then
         update qcs_file set qcsud04 = g_qcs.qcsud04
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
      ...
      if g_qcs.qcsud05 != g_qcs_t.qcsud05 then
         update qcs_file set qcsud05 = g_qcs.qcsud05
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
      ...
      if g_qcs.qcsud06 != g_qcs_t.qcsud06 then
         update qcs_file set qcsud06 = g_qcs.qcsud06
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
      ...
      if g_qcs.qcsud14 != g_qcs_t.qcsud14 then
         update qcs_file set qcsud14 = g_qcs.qcsud14
          where qcs021 = g_qcs.qcs021 and qcs04 = g_qcs.qcs04 and qcs03 = g_qcs.qcs03
         if status then
            call cl_err('upd qcs',sqlca.sqlcode,1)
            rollback work
...
FUNCTION t110_set_no_entry(p_cmd)
   ...
   #darcy:2023/05/22 add s---
    if g_action_choice = 'measure_append' then
        call cl_set_comp_entry("qct07,qct08,qctud02",false)
    end if
    #darcy:2023/05/22 add e---
...
FUNCTION t110_b_fill(p_wc2) #hlf
   ...
   define l_qcs01    like qcs_file.qcs01,
          l_qcs02    like qcs_file.qcs02,
          l_qcs05    like qcs_file.qcs05
   define l_qcs01_2  like qcs_file.qcs01,
   ...
   if l_cnt = 0 then
   #darcy:2023/05/23 add e---
      select unique qct01,qct02,qct021 into l_qcs01_2,l_qcs02_2,l_qcs05_2
      from qcs_file a ,qct_file,qcs_file b
      where a.qcs01= g_qcs.qcs01 and a.qcs02 =g_qcs.qcs02 and a.qcs05=g_qcs.qcs05
         and qct01 =b.qcs01 and qct02=b.qcs02 and qct021 = b.qcs05
         and a.qcs03 = b.qcs03 and a.qcs04=b.qcs04 and a.qcs021=b.qcs021
         and qct11 !=0
      if not cl_null(l_qcs01_2) then
         let l_qcs01 = l_qcs01_2
         let l_qcs02 = l_qcs02_2
         let l_qcs05 = l_qcs05_2
      else
         let l_qcs01 = g_qcs.qcs01
         let l_qcs02 = g_qcs.qcs02
...
#  END IF
#CHI-C30107 ---------------- mark --------------- end
   LET d1 = CURRENT HOUR TO SECOND  #darcy:2023/07/11
   UPDATE qcs_file SET qcs14 = 'Y',
                       qcs15 = TODAY
                       ,qcsud09 = d1 #darcy:2023/07/11 add
    WHERE qcs01 = g_qcs.qcs01
      AND qcs02 = g_qcs.qcs02
      AND qcs05 = g_qcs.qcs05
