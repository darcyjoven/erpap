...
DEFINE
   g_head_1      RECORD
               ...
               #FUN-C80027---ADD---END
                ...
                ,ta_rvw01_h   like rvw_file.ta_rvw01,
                 ta_rvw02   like rvw_file.ta_rvw02,
                 ta_rvw03   like rvw_file.ta_rvw03,
                 ta_rvw04   like rvw_file.ta_rvw04,
                 ta_rvw05   like rvw_file.ta_rvw05,
                 ta_rvw06   like rvw_file.ta_rvw06,
                 ta_rvw07   like rvw_file.ta_rvw07,
                 ta_rvw08   like rvw_file.ta_rvw08,
                 ta_rvw09   like rvw_file.ta_rvw09,
                 ta_rvw10   like rvw_file.ta_rvw10
   ...
   g_rvw         DYNAMIC ARRAY OF RECORD                 #程式變數(Program Variables)
                 ...
                 ,ta_rvw01  like rvw_file.ta_rvw01        #darcy:2023/06/26 add
                 END RECORD,
    ...
    ##########################mark by maoyy20160705 end
            #   IF l_rvw05f_s > 0 THEN   #mark by maoyy20160705
               ...
               IF l_rvw05f_s < 0 THEN
                 ...
                 LET g_cmd = "aapp111 '' '3' '' '' '",g_head_1.rvw02,"' '' '' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'" #No.FUN-CB0053 Add  #add by guanyao160830
                 #CALL cl_cmdrun(g_cmd)       #No.FUN-CB053   Mark
                  CALL cl_cmdrun_wait(g_cmd)  #No.FUN-CB0053  Add
                  SELECT rvw18 INTO g_head_1.rvw18 FROM rvw_file WHERE rvw01 = g_head_1.rvw01   #No.FUN-CB0053 Add
               END IF
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01   #No.FUN-580031  HCN
   ...
   CONSTRUCT BY NAME g_wc ON                               # 螢幕上取單頭條件
               ...
               # ,ta_rvw01_  #darcy:2023/06/19 add
     BEFORE CONSTRUCT
...
DEFINE
   ...
   #FUN-D10064--add--end
   #darcy:2023/06/19 add s---
   select ta_rvw02,ta_rvw03,ta_rvw04,ta_rvw05,ta_rvw06,ta_rvw07,ta_rvw08,ta_rvw09,ta_rvw10
     into g_head_1.ta_rvw02,g_head_1.ta_rvw03,g_head_1.ta_rvw04,g_head_1.ta_rvw05,
          g_head_1.ta_rvw06,g_head_1.ta_rvw07,g_head_1.ta_rvw08,g_head_1.ta_rvw09,g_head_1.ta_rvw10
     from rvw_file
    where rvw01=g_head_1.rvw01
   #darcy:2023/06/19 add e---
   CALL i140_show()
      ...
      AFTER INSERT
        ...
        #LET g_rvw[l_ac].rvw17 = cl_digcut(g_rvw[l_ac].rvw17,t_azi04)    #MOD-CB0281 mark
         ...
         INSERT INTO rvw_file(rvw01,rvw02,rvw03,rvw04,rvw07,rvw11,rvw12,   #MOD-640405
                              ...
                              rvwlegal
                              ,ta_rvw01)   #FUN-9B0130 #darcy:2023/06/19 add
                       VALUES(g_head_1.rvw01,g_head_1.rvw02,g_head_1.rvw03,
                              ...
                              g_legal
                              ,g_rvw[l_ac].ta_rvw01)            #FUN-9B0130 #darcy:2023/06/19 add
...
#                  AND apk28 = g_head_1.rvw07                  #CHI-B30082 add
            ...
            ELSE
               ...
               UPDATE rvw_file SET rvw05f = g_rvw[l_ac].rvw05f,
                                   ...
                                   ta_rvw01 = g_rvw[l_ac].ta_rvw01 #darcy:2023/06/29
                             WHERE rvw01  = g_head_1.rvw01
         ...
         CASE
		    ...
		    CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
                    ...
                    INSERT INTO rvw_file(rvw01,rvw02,rvw03,rvw04,rvw07,rvw11,rvw12,
                                         ...
                                         rvw99,rvwlegal,ta_rvw01)       #FUN-9B0130
                                  VALUES(g_head_1.rvw01,g_head_1.rvw02,g_head_1.rvw03,
                                         g_head_1.rvw04,g_head_1.rvw07,g_head_1.rvw11,
                                         g_head_1.rvw12,
                                         g_head_1.rvwacti,g_head_1.rvwuser,g_head_1.rvwgrup, #FUN-D10064
                                         ...
                                         g_rvw[l_ac].rvw99,g_legal,g_rvw[l_ac].ta_rvw01)      #FUN-9B0130 add
                    IF SQLCA.sqlcode OR SQLCA.SQLERRD[3] = 0 THEN
...
DEFINE  l_cnt   LIKE type_file.num5     #NO FUN-690009 SMALLINT
   ...
   WHILE TRUE
      ...
      UPDATE rvw_file SET rvw_file.rvw01 = g_head_1.rvw01,
                        ...
                        #   ,ta_rvw01 = g_head_1.ta_rvw01_h   #darcy:2023/06/19 add
...
DEFINE
   ...
   INPUT BY NAME g_type,g_head_1.rvw01,g_head_1.rvw02,g_head_1.rvw19,g_head_1.rvw07,   #No.FUN-CB0053   Add g_head_1.rvw19
                 ...
                 ,g_head_1.ta_rvw01_h  #darcy:2023/06/19 add
