...
MAIN
   ...
   LET  l_table = cl_prt_temptable('gapr140',g_sql) CLIPPED
...
FUNCTION gapr140_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        
   ...
   OPEN WINDOW gapr140_w AT p_row,p_col WITH FORM "gap/42f/gapr140"
   ...
   CALL cl_opmsg('p')
WHILE TRUE
   CONSTRUCT BY NAME tm.wc ON rvw01,rvw12
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW gapr140_w 
  ...
  #UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('gapr140',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW gapr140_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0094
          ...
          sr        RECORD
                    ...
                    rvw05   like   rvw_file.rvw05,         #税前金额   
                                             
                    rvw06   like   rvw_file.rvw06,         #税额  
                    sum2    like   rvw_file.rvw05,         #价税合计   
   ...
   LOCATE l_img_blob IN MEMORY             
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='gapr140' 
 
     LET tm.wc = tm.wc CLIPPED 
     
LET l_sql="select rvv06,pmc17,pma02,nmt02,rvw02,rvw01,pmc081,pmc24,pmc52,rvw11,",  
                 "rvw12,'',ima01,ima02,ima021,ima25,rvw10,rvw17,rvv38t,rvw05",
                 "rvw06,'',rvw08,rvwuser,gen02,rvworig,gem02,rvwdate",
     ...
     PREPARE gapr140_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
        EXIT PROGRAM 
     END IF
     DECLARE gapr140_curs1 CURSOR FOR gapr140_prepare1
 
     FOREACH gapr140_curs1 INTO sr.*
     IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
       SELECT pmf02,pmf03 INTO sr.pmf02,sr.pmf03 FROM pmf_file WHERE pmf01 = sr.rvv06
       SELECT nmt02 INTO sr.nmt02 FROM nmt_file WHERE nmt01 = sr.pmf02
       SELECT pma02 INTO sr.pma02 FROM pma_file WHERE pma01 = sr.rvw11
     ...
     CALL cl_prt_cs3('gapr140','gapr140',g_sql,g_str)
