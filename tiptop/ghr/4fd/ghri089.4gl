...
FUNCTION i089_b_fill2()
   ...
   LET g_sql = "SELECT hraa12,hrao02,hrat01,hratid,hrat02,hrat25,hrad03,hrap06,hrat28,hrat30,",
...
FUNCTION i089_b_fill3()
   ...
   LET g_sql = "SELECT hraa12,hrao02,hrat01,hrat02,hrat25,hrad03,hrap06,hrat28,hrat30,",
               "       hrdt02,hrdt03,hrdu05,hrdu04,hrdu03,hrdu07,hrdu08,hrdu09,hrdu10,hratid",
               "  FROM hrat_file,hraa_file,hrao_file,hrap_file,hrdt_file,hrdu_file,hrad_file",
               " WHERE hrat03=hraa01(+) AND hrat04=hrao01(+) ",
               "   AND hrat04=hrap01(+) AND hrat05=hrap05(+) ",
               "   AND hrat19=hrad02(+) AND hrdu02=hrdt01(+)",
...
#   CALL i089_get_hrdu02( ) RETURNING l_name,l_items
 #  CALL cl_set_combo_items("hrdu02",l_name,l_items)
   ...
   WHILE TRUE
      ...
      INPUT BY NAME g_hrdu4.hrdu02,g_hrdu4.hrdu03,g_hrdu4.hrdu04,tyjs 
                    WITHOUT DEFAULTS 
        BEFORE INPUT                                    #預設查詢條件
      AFTER FIELD hrdu02
...
DEFINE l_ac like type_file.num5,
  ...
  SELECT hrat02 INTO l_hrat02 FROM hrat_file WHERE hrat01=g_hrdu_adjust.hrdu01
  
  LET l_msg=g_hrdu2[l_ac].hratida,l_hrat02
 
  IF NOT cl_confirm2('ghr-255',l_msg)  THEN RETURN END IF  
  UPDATE hrdu_file SET hrdu03='002' 
  WHERE hrdu01=g_hrdu_adjust.hrdu01 AND hrdu02=g_hrdu_adjust.hrdu02 AND hrdu04=g_hrdu_adjust.hrdu04
  COMMIT WORK 
