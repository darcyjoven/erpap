...
============.========================.==========================================
*/
create table tc_hrat_file
(
tc_hrat01   number(5) NOT NULL,      /*年份                                   */
tc_hrat02   number(5) NOT NULL,      /*月份                                   */
...
hrat76      varchar2(255),           /*身份证地址                             */
hrat77      date,                    /*最后工作日                             */
hrat78      number(10,2),            /*体重                                   */
hrat79      varchar2(50),
hrat80      varchar2(50),            /*是否建档                               */
hrat81      varchar2(50),            /*存档地点                               */
hrat82      varchar2(50),            /*异动记录                               */
hrat83      varchar2(50),            /*是否关键岗位                           */
hrat84      varchar2(50),
hrat85      date,                    /*建档日期                               */
hrat48      varchar2(40)             /*英文名                                 */
);

create        index ti_tc_hrat_01 on tc_hrat_file (tc_hrat01,tc_hrat02,hrat01);
alter table tc_hrat_file add  constraint tpc_tc_hrat_pk primary key  (tc_hrat01,tc_hrat02,hratid) enable validate;
grant select on tc_hrat_file to tiptopgp;
grant update on tc_hrat_file to tiptopgp;
grant delete on tc_hrat_file to tiptopgp;
grant insert on tc_hrat_file to tiptopgp;
grant index on tc_hrat_file to public;
grant select on tc_hrat_file to ods;
