...
FUNCTION cecr001()
   DEFINE sr        RECORD
               ...
               #darcy:2024/04/18 add s---
               ecbud10  like varchr(100),
               ecbud11  like varchr(100)
  ...
  #公司全名zo02、公司地址zo041、公司電話zo05、公司傳真zo09
   ...
   LET l_sql = "SELECT ecu01,ecu11,'',trim(imaud07),trim(imaud10),ecb03,ecb06,ecb17,ecb40,trim(ecbud04),trim(ecbud05),trim(ecbud03),trim(ecbud02),ima02,''",
               " ,ecbud10,ecbud11",#darcy:2024/04/18 add 
   ...
   FOREACH decl_aaa INTO sr.*
     ...
     let sr.ecbud10 = iif(sr.ecbud11=='1',"UL1","UL2")
     #darcy:2024/04/18 add e---
