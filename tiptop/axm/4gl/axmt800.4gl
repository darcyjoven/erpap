...
##FUN-CC0007---add-----END
 DEFINE
      ...
      ,g_oeq50              like oeq_file.oeq50    #darcy:2023/05/29 add
                  ...
                  IF l_oea11 = '3' THEN #是否由合約轉入
                     ...
                     IF cl_null(l_oeb71) THEN
                        ...
                        IF l_cnt = 0 THEN
                           ...
                           # 备注可以录入新合约单号
                           if not cl_null(g_oeq[l_ac].oeq50) then
                              let l_oea12 = g_oeq[l_ac].oeq50
                           else
                           #darcy:2023/05/29 add e---
                               CALL cl_err('','axm-238',1)
                               NEXT FIELD oeq04a
                           end if #darcy:2023/05/29 add
                        #ELSE #darcy:2023/05/29 mark
                        end if #darcy:2023/05/29 add
  ...
  IF g_cnt=0 THEN
    ...
    INSERT INTO oeb_file(oeb01,oeb03,oeb04,oeb05,oeb05_fac,
                        #oeb06,oeb12,oeb13,oeb17,oeb14,oeb14t,oeb15,oeb72,oeb16,oeb19, #no.7150(add oeb17)    #NO.FUN-920031--addoeb16  #FUN-B20060 add oeb72  #CHI-C80060 mark
                         ...
                         ,oeb41,oeb42,oeb43,oeb37,oeb71
                         ,oebud01)  #darcy:2023/05/29 add                               #FUN-A80118 Add        #FUN-AB0082 add oeb37    #FUN-C70021 add oeb71
      VALUES (g_oep.oep01,g_oeq03,g_oeq04a,g_oeq05a,l_oeb05_fac,
             #g_oeq041a,g_oeq12a,g_oeq13a,g_oeq13a,g_oeq14a,g_oeq14ta,g_oeq15a,g_oeq15a,g_oeq15a,'N',         #NO.FUN-920031--add #FUN-B20060 add g_oeq15a  #CHI-C80060 mark
              ...
              g_plant,g_legal,g_oeq31a,g_oeq32a,g_oeq33a,g_oeq37a,l_oeb71
              ,g_oeq50) #darcy:2023/05/29 add                                       #FUN-A80118 Add g_oeq31a,g_oeq32a,g_oeq33a       #FUN-AB0082 add l_oeb37    #FUN-C70021 add l_oeb71
