...
#
# Pattern name...: asfi30_confirm.4gl
# Descriptions...: 
...
function asfi301_sub_confirm(p_prog,p_docno,p_transaction)
    ...
    if not cl_null(l_sfb.sfb85) and l_cnt > 0 then
        ...
        IF g_success='Y' THEN
            CALL i301sub_firm1_upd(l_sfb.sfb01,"confirm",true)  #CALL原確認的update段 #FUN-8C0081 add #FUN-940008 add false                      
