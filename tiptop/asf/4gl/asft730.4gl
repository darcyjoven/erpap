...
#darcy:2023/10/17 add e---
   ...
   #darcy:2023/10/17 add s---
   # 报工工序才可以下线
   select ta_sgm06,shb06,shb111,shb081 into l_ta_sgm06,l_shb06,g_tsc.tsc05,l_shb081 from sgm_file,shb_file #darcy:2024/07/04 add shb06,shb111
    where sgm01 = shb16 and shb01 = g_shb01
      and shb081 = sgm04
   if cl_null(l_ta_sgm06) or l_ta_sgm06 == 'N' then
      call cl_err("","ctm-006",1)
      return
   end if
   #darcy:2023/10/17 add e---
    ...
    let l_status = 'Y'
    call cl_progressing("建立下线BOM")
    call cs_asf_gen_offine(g_shb05,l_shb081,false) returning g_tsc.tsc03,l_ok
    if not l_ok then
        call cl_err(g_tsc.tsc03,"ctm-008",1)
        let l_status = 'N'
        rollback work
...
#atmt260单头
    BEGIN WORK 
      ...
      #   LET g_tsc.tsc05=0 #darcy:2024/07/04 mark
        LET g_tsc.tsc08=0
        LET g_tsc.tsc11=0
        ...
        SELECT ima35,ima36 INTO g_tsc.tsc12,g_tsc.tsc13 FROM ima_file WHERE ima01 = g_tsc.tsc03  #仓库，库位 #darcy:2024/07/04 mod tsc03
        let g_tsc.tsc14 = sfmt("%1-%2",g_shb05,l_shb06)  #darcy:2024/07/04 add
        ...
        call cl_progressing("产生下线单据资料") sleep 0.5 #darcy:2024/07/04 add
        ...
        #ELSE #darcy:2024/07/04 mark
            #LET l_status = 'Y' #darcy:2024/07/04 mark
        END IF
