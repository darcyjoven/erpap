...
#TQC-B70021   
   ...
   DECLARE s_fsgl_flows_c2 CURSOR FOR
    SELECT tic04,tic05,tic06,nml02,tic08,tic07f,tic07  #add by dengsy170212
      FROM tic_file LEFT OUTER JOIN nml_file ON nml01=tic06   
     WHERE tic00 = l_tic00
       AND tic01 = l_tic01
       AND tic02 = l_tic02
       AND tic04 = (SELECT aba07 FROM aba_file WHERE aba01=p_no) 
     ORDER BY tic04
   ...
   LET i=1
   LET l_rec_b=0
   FOREACH s_fsgl_flows_c2 INTO g_tic[i].*
      IF STATUS THEN
