...
DEFINE tm  RECORD                # Print condition RECORD
              ...
              onlyexcel like type_file.chr1,  #darcy:2023/06/14 add
...
MAIN
   ...
   #        ,",tmp07.faj_file.faj60"                              #CHI-C70003   Add
    LET g_sql="faj04.faj_file.faj04,",
              ...
              ,",faj061.faj_file.faj061" #darcy:2023/02/08 add
...
DEFINE   p_row,p_col   LIKE type_file.num5,      #No.FUN-680070 SMALLINT
   ...
   LET tm.a    = 'Y'
   LET tm.onlyexcel    = 'Y'  #darcy:2023/06/14 add
   LET tm.b    = 'Y'
...
#FUN-B60045   ---end     Add
      ...
      END IF
      let tm.onlyexcel ='Y'
      DISPLAY BY NAME tm.s,tm.t,tm.v,tm.yy1,tm.mm1,tm.a,tm.b,tm.d,tm.onlyexcel,tm.more     #darcy:2023/06/14 add excel #No.FUN-B50133 add tm.d
      INPUT BY NAME
         tm.e,tm2.s1,tm2.s2,tm2.s3,tm2.t1,tm2.t2,tm2.t3,                 #FUN-B60045   Add tm.e
         tm2.u1,tm2.u2,tm2.u3,tm.yy1,tm.mm1,tm.a,tm.b,tm.c,tm.d,tm.onlyexcel,tm.more #darcy:2023/06/14 add excel #No.CHI-480001   #No.FUN-B50133 add tm.d
         WITHOUT DEFAULTS
         ...
         #darcy:2023/06/14 add s---
         AFTER FIELD onlyexcel
            IF tm.onlyexcel NOT MATCHES "[YN]" THEN
               NEXT FIELD FORMONLY.onlyexcel
            END IF
         #darcy:2023/06/14 add e---
...
#FUN-B60045   ---start   Add
         AFTER FIELD e
            IF NOT cl_null(tm.e) THEN
               ...
               LET tm2.u2 = 'N'
               LET tm2.u3 = 'N'
               DISPLAY BY NAME tm.a,tm.b,tm2.s1,tm2.t1,tm2.u1,tm2.s2,tm2.s3,tm2.t2,tm2.t3,tm2.u2,tm2.u3,tm.onlyexcel #darcy:2023/06/14 add excel
...
DEFINE l_n      LIKE type_file.num5   #FUN-B60045   Add
   DEFINE l_name     LIKE type_file.chr20,             # External(Disk) file name       #No.FUN-680070 VARCHAR(20)
          ...
          sr           RECORD order1 LIKE faj_file.faj06,  #No.FUN-680070 VARCHAR(30)
                              ...
                              ,faj061    like faj_file.faj061 #darcy:2023/02/08 add
                        END RECORD
   ...
   #FUN-C90088--E--
     ...
     IF tm.d = '1' THEN                #No.FUN-B50133  ADD
        LET l_sql = "SELECT '','','',",
                    ...
                    "  ,fajud04,gem02,faj061 ",  #add by darcy:2022/10/10 #darcy:2022/10/25 add #darcy:2023/02/08 add faj061
   ...
   #No.FUN-B50133---add--start--
     ELSE
        LET l_sql = "SELECT '','','',",
                    ...
                    "  ,gem02,faj061 ",#darcy:2022/10/25 add #darcy:2023/02/08 add faj061
                    "  FROM faj_file,OUTER fab_file,OUTER gen_file,OUTER faf_file",
                    "  ,OUTER pmc_file ",  #add by dengsy170212
                    "  ,gem_file ", #darcy:2022/10/25 add
                    " WHERE fajconf='Y' AND ",tm.wc CLIPPED,
...
#FUN-B60045   ---end     Add
          ...
          SELECT SUM(fan08),SUM(fan15),SUM(fan17)
            INTO l_fan08,l_fan15,l_fan17 FROM fan_file      #end No.CHI-480001
              WHERE fan01=sr.faj02 AND fan02=sr.faj022
                ...
                AND fan041 IN ('0','1')    #MOD-670028
                AND fan05 IN ('1','2')    #No.MOD-540112
          #darcy:2023/04/25 add s---
          if cl_null(l_fan15) then
            # 最新一次的累计折旧
            let l_sql = " select fan15 from ( ",
                        " select fan01,fan03,fan04,fan15,dense_rank() over(partition by fan01 order by fan03 desc,fan04 desc ) r ",
                        " from fan_file ",
                        " where fan041 in ('0', '1') ",
                        "    and fan05 in ('1', '2') ",
                        "    and fan01=? and fan02 = ? and fan02=sr.faj022) where r=1 "
            prepare r201_last_fan15 from l_sql
            execute r201_last_fan15 using sr.faj02,sr.faj022 into l_fan15
          end if
          #darcy:2023/04/25 add e---
          #add by wy20170523 b
   ...
   #darcy:2022/11/21 mark e---
     EXECUTE insert_prep USING
                         ...
                         ,sr.faj061 #darcy:2023/02/08 add
   #MOD-CC0015  -- modify end #調整sql與XML一致；方便開發、提高CR效能 --
#FUN-B60045   ---start   Add
     IF NOT cl_null(tm.e) THEN
...
#CHI-C60010--add--end                                                                                                              
     ...
     #darcy:2023/06/14 add s---
     if tm.onlyexcel = 'Y' then
         call cl_fast_query_zat(
            "tqrczz0004",
            g_sql,
            true
         )
