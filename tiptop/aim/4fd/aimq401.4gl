...
DEFINE  lc_qbe_sn    LIKE gbm_file.gbm01    #No.FUN-580031  HCN
   ...
   CALL g_img.clear()
           ...
           CONSTRUCT BY NAME tm.wc ON imd01,chk1   #add by huanglf160927
...
#str----end by huanglf160927
        ...
        IF g_imd.chk1 = 'N' THEN 
           CONSTRUCT tm.wc2 ON img01,img03,img04,img09,img10,img19,img36,img37
                     FROM s_img[1].img01,s_img[1].img03,s_img[1].img04,s_img[1].img09,
                          s_img[1].img10,s_img[1].img19,s_img[1].img36,s_img[1].img37
        ELSE         
           CONSTRUCT tm.wc2 ON img01,img03,img09,img10,img19,img36,img37
                     FROM s_img[1].img01,s_img[1].img03,s_img[1].img09,
                          s_img[1].img10,s_img[1].img19,s_img[1].img36,s_img[1].img37
        END IF   #add by huanglf160927
...
ELSE 
   ...
   LET l_sql1 =
        "SELECT img01, ima02, ima021,imaud10, '','', '', '', sum(img10), ",  #MOD-6A0130 modify  #add imaud10 by guanyao160913
...
ELSE
    ...
    LET l_sql2 =
        ...
        " WHERE img02 = '",g_imd.imd01,"' AND ", tm.wc2 CLIPPED,
        " AND   img_file.img01 = ima_file.ima01",   #FUN-640006
        " AND   img01 = '",g_img[g_cnt].img01,"' img03 = '",g_img[g_cnt].img03,"'"
    PREPARE q401_pb2 FROM l_sql2
    EXECUTE q401_pb2 INTO g_img[g_cnt].img09,g_img[g_cnt].img10_1,g_img[g_cnt].img19
                         ,g_img[g_cnt].img36,g_img[g_cnt].img37
#--TQC-CC0003--add----star---
        SELECT ime03  INTO g_img[g_cnt].ime03 FROM ime_file WHERE ime02 = g_img[g_cnt].img03 
                AND ime01 = g_imd.imd01  #add by guanyao160802
        DISPLAY g_img[g_cnt].ime03 TO ime03
