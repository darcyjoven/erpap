...
#              "   AND ",tm.wc2 CLIPPED
    ...
    LET l_sql= "SELECT 0,'",g_bma.bma01,"', bmb02, bmb03, bmb09,bmb16,bmbud06, (bmb06/bmb07), bmb10, bmb13, bmb01",  #CHI-CB0050 add bmb09
               "  FROM bmb_file",
...
FUNCTION q501_b_fill()              #BODY FILL UP
   DEFINE i	LIKE type_file.num5          #No.FUN-680096 SMALLINT
    ...
    DECLARE q501_bcs CURSOR FOR
                SELECT x_level,bmb01,bmb02,bmb03,ima02,ima021,bmb09,bmb16, #MOD-510115 #MOD-5A0257 unmark #CHI-CB0050 add bmb09
                       bmbud06,bmb06,bmb10,bmb13 #MOD-850129   #MOD-860144 
