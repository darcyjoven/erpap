...
#FUN-CB0078 ------End--------
         ...
         WHEN "cecp300"
            IF cl_chk_act_auth() THEN
                let l_cmd = "cecp300 '",g_bma.bma01,"' '' 'Y' 'N' "
         ...
         WHEN "confirmp"
            IF cl_chk_act_auth() THEN
               ...
               ELSE
                  #darcy:2023/04/14 mod s---
                  CALL s_cbmp600(" 1=1 AND bma01 ='"||g_bma.bma01||"' AND bma06 = NVL('"||g_bma.bma06||"',' ') ",false)
                  #darcy:2023/04/14 mod e---
...
define l_imaud32     like ima_file.imaud32  #darcy:2023/07/15 add
...
#FUN-C20105 --end--
        ...
        AFTER FIELD bmb03                         #(元件料件)
            ...
            #darcy:2023/07/15 add s---
            if l_imaud32 = 1 then
               call cl_err(g_bmb[l_ac].bmb03,'cbm-023',1)
               next field bmb03
            end if
            #darcy:2023/07/15 add e---
