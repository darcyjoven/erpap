...
create unique index tic_dea_01 on tc_dea_file (tc_dea01);
create        index tic_dea_02 on tc_dea_file (tc_dea01,tc_dea02);
grant select on tc_dea_file to tiptopgp;
grant update on tc_dea_file to tiptopgp;
grant delete on tc_dea_file to tiptopgp;
grant insert on tc_dea_file to tiptopgp;
grant index on tc_dea_file to public;
grant select on tc_dea_file to ods;
