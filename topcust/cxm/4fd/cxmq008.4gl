...
DEFINE g_argv1         LIKE sfv_file.sfv00  
...
DEFINE g_sfv00         LIKE sfv_file.sfv00   #add by huanglf161114
DEFINE g_sfv07         LIKE sfv_file.sfv07
DEFINE g_sfv061        LIKE sfv_file.sfv061
DEFINE g_sfv22         LIKE sfv_file.sfv22
DEFINE g_sql           STRING 
...
DEFINE l_sfv11   LIKE sfv_file.sfv11,
       ...
       l_sfv28   LIKE sfv_file.sfv28,
       l_sfv18   LIKE sfv_file.sfv18,
       l_flag    LIKE type_file.chr1,
       t_azi04   LIKE azi_file.azi04
DEFINE  l_sum1   LIKE sfv_file.sfv19,
         l_sum2   LIKE sfv_file.sfv19,
         l_sum3   LIKE sfv_file.sfv19,
         l_sum4   LIKE sfv_file.sfv19,
         l_sum5   LIKE sfv_file.sfv19,
         l_sum6   LIKE sfv_file.sfv19,
         l_sum7   LIKE sfv_file.sfv16, 
         l_oha09  LIKE oha_file.oha09,
         l_sfv19x  LIKE sfv_file.sfv19x,
         l_sfv29x   LIKE sfv_file.sfv29x
