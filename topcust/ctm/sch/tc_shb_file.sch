...
tc_shbud03  varchar2(40),            /*自定义字段                             */
tc_shbud04  varchar2(40),            /*自定义字段                             */
tc_shbud05  date,                    /*自定义字段                             */
tc_shbud06  date,                    /*自定义字段                             */
tc_shbud07  number(10),              /*机器数                                 */
tc_shbud08  number(10),              /*人数                                   */
tc_shbud09  number(15,3),            /*自定义字段                             */
tc_shbud10  number(15,3),            /*自定义字段                             */
