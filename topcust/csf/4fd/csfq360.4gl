...
DEFINE g_date   DAT
DEFINE g_nochk    type_file.chr1   #darcy:2022年1月11日 add 
...
#No.FUN-930009 --End
      ...
      ON ACTION controlg      #MOD-4C0121
		...
		#No.FUN-580031 --end--       HCN
         #  END CONSTRUCT    #darcy:2022年1月11日 mark
   END DIALOG  #darcy:2022年1月11日 add
...
#add by donghy 170313
  ...
  IF cl_null(m_wc2) THEN LET m_wc2 = ' 1=1 ' END IF}
    ...
    LET l_sql =
       ...
       #darcy:2022-1-11 s---
   IF g_nochk THEN
      LET l_sql = l_sql," AND NOT exists (select 1 from  ecb_file b WHERE a.ecb06= b.ecb06 AND a.ecb08 = b.ecb08 AND substr(a.sfb05,0,7)=substr(b.ecb01,0,7) ",
       "  AND a.sfb05 <> b.ecb01)"
   ELSE
