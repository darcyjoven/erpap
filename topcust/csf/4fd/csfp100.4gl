...
FUNCTION p100_i()
   ...
   DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
      ...
      END CONSTRUCT
      INPUT tm.begin,tm.end,tm.cfconfirm,tm.fcnt,tm.ecb02,tm.ecb03,tm.ecb06 FROM sfb22,sfb15,cfconfirm,fcnt,ecb02,ecb03,ecb06
         BEFORE INPUT
            
            DISPLAY  tm.cfconfirm,tm.fcnt TO cfconfirm,fcnt
         ...
         ON CHANGE cfconfirm 
            IF tm.cfconfirm ='Y' THEN
               CALL cl_set_comp_entry("ecb03,ecb06,fcnt",TRUE) 
            ELSE 
               CALL cl_set_comp_entry("ecb03,ecb06,fcnt",FALSE)
               DISPLAY '','','' TO ecb03,ecb06,ecb17
            END IF
...
#TODO 计算第1阶料号
   ...
   LET l_where = " m.tc_shb08=n.tc_shb08 AND m.tc_shb06=n.tc_shb06 AND m.tc_shb121=n.tc_shb121 AND
                  ...
                  m.bmb10=n.bmb10 "
   IF cl_null(tm.cfconfirm) OR tm.cfconfirm ='N' THEN 
   ...
   IF NOT cl_null(l_cnt ) OR l_cnt > 0  THEN 
      ...
      CALL cl_cmdrun_wait("csfr100 '"||g_no||"' 'Y' ")
      MESSAGE ""
   END IF
