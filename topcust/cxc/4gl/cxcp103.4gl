...
#                #  ,"and oga01 ='XRP-23040599' " #darcy:2023/07/05 add 临时加上方便排查问题 
...
#                      # ,"and 1=2 " #darcy:2023/07/05 add 临时加上方便排查问题 
...
define l_omf string  #darcy:2023/07/05 add

LET l_dd3 = s_getlastday(MDY(tm.mm ,'1',tm.yy))

    #darcy:2023/07/05 add s---
    # 开票信息
    let l_omf = "SELECT omf11, omf12, nvl(SUM(omf16), 0) omf16",
                "  FROM omf_file",
                " WHERE omf31 <= '",l_dd3,"'",
                " AND omf08 = 'Y'",
                " AND omf11 != ' '",
                " GROUP BY omf11, omf12"
    #darcy:2023/07/05 add e---
   ...
   LET l_sql =" SELECT  oga01,oga02,oga03,oga032,oga04,oga14,oga15,oga21,oga211,ogb03,", 
              ...
              "  ,oga08 ,nvl(omf16,0)", #darcy:2023/07/05 add nvl(omf16,0)  #add by dengsy170213
              " from oga_file,ogb_file  ",
              " left join (",l_omf,") on omf11 = ogb01 AND omf12 = ogb03 ", #darcy:2023/07/05 add
              " WHERE oga01=ogb01 ", 
            ...
            #   " AND   oga01='",g_oga01,"'" 
             ...
             " AND oga65 = 'N'",
             " AND (oga00 = '1' OR oga00 = '4' OR oga00 = '8')",
             " AND ogapost = 'Y'",
             " AND ((oga01 <> '8' AND",
             "     ((oga02 < to_date('170301', 'yymmdd') AND oga08 = '1') OR",
             "     (oga02 >= to_date('170301', 'yymmdd')))) OR oga01 = '8')",
             "     AND ogb12<>NVL(omf16,0)"
             #darcy:2023/07/05 add e---
...
#zhouxm151124 add start
   LET l_sql=l_sql," UNION SELECT  oha01,oha02,oha03,oha032,oha04,oha14,oha15,oha21,oha211,ohb03,", 
              ...
              " ,oha08 ,nvl(omf16,0)", #darcy:2023/07/05 add nvl(omf16,0)
              " from oha_file,ohb_file  ",  
              " left join (",l_omf,") on omf11 = ohb01 AND omf12 = ohb03 ", #darcy:2023/07/05 add
              " WHERE oha01=ohb01 ", 
            ...
            #   " AND oha01='",g_oga01,"'" 
             ...
             #," and oha08='1'" #add by wy20170510 #mark by pane 210303
              ...
              ," AND ohb12 * (-1)<> NVL(omf16,0) AND ohapost = 'Y' AND ohaconf = 'Y' " #darcy:2023/07/05 add 
#zhouxm151124 add end             
   ...
   FOREACH p100_c2 INTO  g_tc_omb.tc_omb01,g_tc_omb.tc_omb02,g_tc_omb.tc_omb03,g_tc_omb.tc_omb032,g_tc_omb.tc_omb04,
                         ...
                         ,l_oga08,g_tc_omb.tc_omb20   #add by dengsy170213 #darcy:2023/07/05 add tc_omb20
