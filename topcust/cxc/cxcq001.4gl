...
DEFINE g_ape      DYNAMIC ARRAY OF RECORD
                 ...
                 BJYL LIKE type_file.num20_6,
                 LJYL LIKE type_file.num20_6,
                 dwzhl LIKE type_file.num20_6,
                 sjcsl LIKE type_file.num20_6,
                 trsl  LIKE type_file.num20_6,
                 zcsl  LIKE type_file.num20_6,
                 czcsl LIKE type_file.num20_6,
                 ejcsl LIKE type_file.num20_6,
 ...
 DEFINE g_ape_1      DYNAMIC ARRAY OF RECORD
                 ...
                 imd02_1 LIKE type_file.num5,
                 img03   LIKE type_file.num20_6,
                 dwzhl_1 LIKE type_file.num20_6,
                 sjcsl_1 LIKE type_file.num20_6,
                 trsl_1  LIKE type_file.num20_6,
                 zcsl_1  LIKE type_file.num20_6,
                 ejcsl_1 LIKE type_file.num20_6,
...
#cx4             
   LET g_sql = " INSERT INTO cxcq001_tmp02 ",
               " SELECT yjlh,bjyl,ljyl,cch01,sfb02,
                        sfb99,sfb05,CP.ima02,CP.ima021,CP.ima57,
...
#CX5
   LET g_sql = " INSERT INTO cxcq001_tmp02 ",
               " SELECT BOM.YJLH,BOM.BJYL,BOM.LJYL,cch01,sfb02,
                        sfb99,sfb05,CP.ima02,CP.ima021,CP.ima57,
   ...
   LET g_sql = " SELECT yjlh,bjyl,round(ljyl,6),round(ljyl/decode(bjyl,0,1,bjyl),4),
                        (CASE WHEN yjlh = cch04 THEN cch11 ELSE cch11*ljyl END),
                        (CASE WHEN yjlh = cch04 THEN cch21 ELSE cch21*ljyl END ),
                        (CASE WHEN yjlh = cch04 THEN cch31 ELSE cch31*ljyl END ),
                        (CASE WHEN yjlh = cch04 THEN cch41 ELSE cch41*ljyl END ),
                        (CASE WHEN yjlh = cch04 THEN cch91 ELSE cch91*ljyl END ),
                        cch01,sfb02,
                        sfb99,sfb05,ima02,ima021,ima57,
                        cch04,ima02a,ima021a,ima57a,sfb98,
                        cch11,cch21,cch31,cch41,cch91,
                        aag01,aag02     
                   from cxcq001_tmp02 "   
   ...
   LET g_tot51 = 0
    FOREACH q001_bcs INTO g_ape[g_cnt].*
       IF SQLCA.sqlcode THEN
          ...
          EXIT FOREACH
       END IF
         LET g_tot11 = g_tot11 + g_ape[g_cnt].cch11_1
     LET g_tot21 = g_tot21 + g_ape[g_cnt].cch21_1
     LET g_tot31 = g_tot31 + g_ape[g_cnt].cch31_1
     LET g_tot41 = g_tot41 + g_ape[g_cnt].cch41_1
     LET g_tot51 = g_tot51 + g_ape[g_cnt].cch91_1
       LET g_cnt = g_cnt + 1
...
#CX6                        
    LET g_sql = " INSERT INTO cxcq001_tmp04 ",
                " SELECT CX1.ta_ccc01,1,1,FP.ima01,FP.ima02,FP.ima021,FP.imk02,FP.imd02,FP.ima25,FP.qcsl,FP.rksl,FP.cksl,FP.qmsl",
...
#CX7                        
    LET g_sql = " INSERT INTO cxcq001_tmp04 ",
                " SELECT CX3.yjlh,CX3.bjyl,CX3.ljyl,CX3.cplh,FP.ima02,FP.ima021,FP.imk02,FP.imd02,FP.ima25,FP.qcsl,FP.rksl,FP.cksl,FP.qmsl",
...
#CX8                        
    LET g_sql = " INSERT INTO cxcq001_tmp04 ",
                " SELECT BOM.YJLH,BOM.BJYL,BOM.LJYL,BOM.CPLH,FP.ima02,FP.ima021,FP.imk02,FP.imd02,FP.ima25,FP.qcsl,FP.rksl,FP.cksl,FP.qmsl",
                "   FROM  cxcq001_tmp03 FP ",
                "   left join (select distinct CPLH,YJLH,BJYL,LJYL,YY,MM from EX_BOM_CP ",
                "               where yy=",g_argv1," and mm=",g_argv2," 
                                  AND to_char(sxrq1, 'yyyyMM') <= '",l_chr,"' 
    ...
    LET g_sql = " select cch04,imd02_1,round(img03,6),round(img03/decode(imd02_1,0,1,imd02_1),6),
                         (CASE WHEN cch04 = ima01 THEN qcsl ELSE qcsl*img03 END ),
                         (CASE WHEN cch04 = ima01 THEN rksl ELSE rksl*img03 END ),
                         (CASE WHEN cch04 = ima01 THEN cksl ELSE cksl*img03 END ),
                         (CASE WHEN cch04 = ima01 THEN qmsl ELSE qmsl*img03 END ),
    ima01,ima02,
                         ima021,imk02,imd02,ima25,qcsl,
                         rksl,cksl,qmsl    from cxcq001_tmp04 "                     
   ...
   LET g_tot01 = 0
    ...
    FOREACH q001_bcs1 INTO g_ape_1[g_cnt].*
     ...
     LET g_tot71 = g_tot71 + g_ape_1[g_cnt].QCSL
     LET g_tot81 = g_tot81 + g_ape_1[g_cnt].RKSL
     LET g_tot91 = g_tot91 + g_ape_1[g_cnt].CKSL
     LET g_tot01 = g_tot01 + g_ape_1[g_cnt].QMSL
 ...
 DROP TABLE cxcq001_tmp02
   CREATE TEMP TABLE cxcq001_tmp02
     (yjlh          LIKE cch_file.cch04,            
      bjyl          LIKE type_file.num5,              
      ljyl          LIKE type_file.num5,
...
#page2
 DROP TABLE cxcq001_tmp04
   CREATE TEMP TABLE cxcq001_tmp04
     (cch04    LIKE cch_file.cch04,
      imd02_1  LIKE type_file.num20_6,
      img03    LIKE type_file.num20_6,
      ima01    LIKE ima_file.ima01,
      ima02    LIKE ima_file.ima02,
      ima021   LIKE ima_file.ima021,
