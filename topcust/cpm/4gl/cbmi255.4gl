...
#                                    tc_pmj_file add 2 fields:tc_pmj031,tc_pmj032
...
# Modify.........: No.FUN-4B0025 04/11/05 By Smatc_pmin ARRAY轉為EXCEL檔
...
# Modify.........: No.MOD-530582 05/03/30 By Mandy 單身輸入後的附畫面(i255a_w),廠牌編號沒有勾稽,與atc_pmi254控管邏輯不同(請一併提供開窗功能)
...
# Modify.........: No.MOD-530616 05/03/30 By Mandy 在cbmi255的'供應商基本資料維護'功能,可直接傳參數到atc_pmi600查詢單據供應商資料(須考慮權限控管)
...
# Modify.........: NO.MOD-590519 05/09/30 BY yiting 輸入單身時,CALL i255_tc_pmj03_add()會開畫面i255a_w,KEY IN完資料後,此i255a_w視窗沒有馬上被關閉
...
# Modify.........: No.TQC-7B0089 07/11/15 By lumxa  cbmi255&cbmi265.dbo.tc_pmj_file r l件 ]有考 ]新增加的key值字段tc_pmj10,tc_pmj12,這樣會導致問題
# Modify.........: No.TQC-810025 08/01/08 By lumxa  在程序atc_pmi254 cbmi255 atc_pmi258中增加了新增的key值的 在修改單身時 key值賦值錯誤
...
# Modify.........: No.MOD-880193 08/08/25 By chenl  增加tc_pmj10變量判斷，若為空，則賦值為空格(' ')
# Modify.........: No.FUN-8A0054 08/10/13 By sabrina 若沒有勾選〝與GPM整合〞，則不做GPM控管
# Modify.........: No.CHI-880028 08/10/13 By xiaofeizhu 新增欄位價格型態tc_pmi10
# Modify.........: No.MOD-8B0235 08/11/24 By chenyu pmh11增加控管
# Modify.........: No.TQC-8C0068 08/12/24 By Smatc_pmin 調整Drop table的執行時機
# Modify.........: No.MOD-910036 09/01/12 By Smatc_pmin 修正幣別位數取位問題
# Modify.........: No.MOD-910185 09/01/16 By Smatc_pmin 單身筆數計算錯誤
# Modify.........: No.CHI-910021 09/02/01 By xiaofeizhu 有select bmd_file或select pmh_file的部份，全部加入有效無效碼="Y"的判斷
# Modify.........: No.MOD-920027 09/02/03 By sherry 1、審核和取消審核以后更新最近更改者和最近更改日
#                                                   2、新增的時候不應寫入最近更改者
# Modify.........: No.MOD-920024 09/02/03 By Smatc_pmin 廠商性質需為1|3類
...
# Modify.........: No.MOD-930327 09/04/03 By Smatc_pmin 供應商/料件對應資料若為無效,則不可輸入核價檔
# Modify.........: No.MOD-960211 09/06/22 By mike 將AND改為OR
# Modify.........: No.MOD-960182 09/07/07 By Smatc_pmin 抓取tc_pmj_file時,條件要多加tc_pmj10/tc_pmj12
...
# Modify.........: No.FUN-9C0046 09/12/09 By chenls  (1)單身添加欄位tc_pmj14
#                                                     (2)刪除核價單身資料時 判斷tc_pmj14是否為空
...
# Modify.........: No:MOD-A10179 10/01/27 By Smatc_pmin 修改時,一直卡在單號的地方造成無窮迴圈
...
# Modify.........: No.FUN-A30072 10/10/22 by jan 新增欄位tc_pmjicd14
...
# Modify.........: No:MOD-C30260 12/03/10 By zhuhao 由詢價單轉入時(i255_b_g)，項次tc_pmj02，改用MAX加1，不要用變數直接累加
...
DEFINE
    ...
    g_tc_pmj           DYNAMIC ARRAY OF RECORD #程式變數(Program Variables)
        ...
        tc_pmj11       LIKE tc_pmj_file.tc_pmj11,   #工艺说明  
...
ELSE
   ...
   CONSTRUCT g_wc2 ON tc_pmj02,tc_pmj03,tc_pmj031,tc_pmj032,tc_pmj11,tc_pmj04,tc_pmj10,tc_pmjicd14,tc_pmj05,		 #FUN-A30072
                      ...
                      tc_pmj08,tc_pmj09,tc_pmj13,tc_pmj14             #No.FUN-810017 Add tc_pmj13
           FROM s_tc_pmj[1].tc_pmj02,s_tc_pmj[1].tc_pmj03,s_tc_pmj[1].tc_pmj031,s_tc_pmj[1].tc_pmj032,s_tc_pmj[1].tc_pmj11,
                s_tc_pmj[1].tc_pmj04,s_tc_pmj[1].tc_pmj10,s_tc_pmj[1].tc_pmjicd14,s_tc_pmj[1].tc_pmj05,	 #FUN-A30072
                s_tc_pmj[1].tc_pmj06,s_tc_pmj[1].tc_pmj06t,    #No.FUN-550019
                s_tc_pmj[1].tc_pmj07,s_tc_pmj[1].tc_pmj07t,    #No.FUN-550019
                s_tc_pmj[1].tc_pmj08,s_tc_pmj[1].tc_pmj09,s_tc_pmj[1].tc_pmj13,s_tc_pmj[1].tc_pmj14 #No.FUN-810017 
		#No.FUN-580031 --start--     HCN
		BEFORE CONSTRUCT
            ...
            IF cl_chk_act_auth() THEN
               IF g_tc_pmi.tc_pmi05 = 'Y' THEN
                  ...
                  IF g_cnt>=1 THEN
                     ...
                     LET g_cmd = "cbmi255c '",g_tc_pmi.tc_pmi01 CLIPPED,"' ", #MOD-530616
...
DEFINE  l_COUNT  INT
   ...
   CALL cl_opmsg('b')
    ...
    LET g_forupd_sql = "SELECT tc_pmj02,tc_pmj03,tc_pmj031,tc_pmj032,tc_pmj11,tc_pmj04,'','',tc_pmj10,'','',tc_pmj13,tc_pmjicd14,tc_pmj05,tc_pmj06,",  #FUN-560193 add '','' #FUN-930061 add ''	 #FUN-A30072   
                       "       tc_pmj06t,tc_pmj07,tc_pmj07t,tc_pmj08,tc_pmj09,tc_pmj14 ", #No.FUN-550019  #No.FUN-9C0046 ..Add tc_pmj14
                       "  FROM tc_pmj_file",
    ...
    INPUT ARRAY g_tc_pmj WITHOUT DEFAULTS FROM s_tc_pmj.*
        ...
        AFTER INSERT
           ...
           INSERT INTO tc_pmj_file(tc_pmj01,tc_pmj02,tc_pmj03,tc_pmj031,tc_pmj032,tc_pmj11,tc_pmj04,tc_pmj05,
                                ...
                                tc_pmj12,tc_pmj13,tc_pmjicd14,tc_pmjplant,tc_pmjlegal)  #No.FUN-670099 #No.FUN-810017 #FUN-980006 add tc_pmjplant,tc_pmjlegal  #FUN-A30072
                VALUES(g_tc_pmi.tc_pmi01,g_tc_pmj[l_ac].tc_pmj02,
                       ...
                       g_tc_pmj12,g_tc_pmj[l_ac].tc_pmj13,g_tc_pmj[l_ac].tc_pmjicd14,g_plant,g_legal)  #No.FUN-670099 #No.FUN-810017 #FUN-980006 add g_plant,g_legal  #FUN-A30072
           IF SQLCA.sqlcode OR SQLCA.sqlerrd[3]=0 THEN
        ...
        AFTER FIELD tc_pmj05
              ...
              ELSE
                 ...
                 SELECT COUNT(*) INTO l_n FROM tc_pmj_file
                  WHERE tc_pmj03=g_tc_pmj[l_ac].tc_pmj03
                    ...
                    AND tc_pmj05=g_tc_pmj[l_ac].tc_pmj05
                    AND tc_pmj10=g_tc_pmj[l_ac].tc_pmj10
                    AND tc_pmj11=g_tc_pmj[l_ac].tc_pmj11
                    AND tc_pmj13=g_tc_pmj[l_ac].tc_pmj13    #No.TQC-930072 add
                    AND tc_pmj12=g_tc_pmj12  #No.FUN-670099
                       AND tc_pmjicd14=g_tc_pmj[l_ac].tc_pmjicd14
                 ELSE
           ...
           IF g_tc_pmi.tc_pmi05 = 'Y' THEN
              ...
              IF l_n = 0 THEN 
                 ...
                 LET g_cmd = "cbmi255c '",g_tc_pmi.tc_pmi01 CLIPPED,"' ", g_tc_pmj[l_ac].tc_pmj02 CLIPPED," '",
...
#FUN-AA0059 --End--
              ...
              WHEN INFIELD(tc_pmj11)     #工艺说明
                 ...
                 #LET g_qryparam.default1 = g_tc_pmj[l_ac].tc_pmj03
                 CALL cl_create_qry() RETURNING g_tc_pmj[l_ac].tc_pmj11
                  DISPLAY BY NAME g_tc_pmj[l_ac].tc_pmj11           #No.MOD-490371
                 NEXT FIELD tc_pmj11
...
DEFINE
    ...
    CONSTRUCT l_wc2 ON tc_pmj02,tc_pmj03,tc_pmj11,tc_pmj04,tc_pmj10 ,tc_pmjicd14,tc_pmj05,	   #FUN-A30072
                       tc_pmj06,tc_pmj06t,tc_pmj07,tc_pmj07t,tc_pmj08,tc_pmj09,tc_pmj13,tc_pmj14      #No.FUN-810017 add tc_pmj13   #No.FUN-9C0046 add tc_pmj14
            FROM s_tc_pmj[1].tc_pmj02,s_tc_pmj[1].tc_pmj03,s_tc_pmj[1].tc_pmj11,s_tc_pmj[1].tc_pmj04,s_tc_pmj[1].tc_pmj10,
                 s_tc_pmj[1].tc_pmjicd14,s_tc_pmj[1].tc_pmj05,s_tc_pmj[1].tc_pmj06,s_tc_pmj[1].tc_pmj06t,  #FUN-A30072
                 s_tc_pmj[1].tc_pmj07,s_tc_pmj[1].tc_pmj07t,
                 s_tc_pmj[1].tc_pmj08,s_tc_pmj[1].tc_pmj09,s_tc_pmj[1].tc_pmj13,s_tc_pmj[1].tc_pmj14         #NO.FUN-810017 add tc_pmj13  #No.FUN-9C0046 add tc_pmj14 
              BEFORE CONSTRUCT
                 CALL cl_qbe_init()
...
DEFINE  i        LIKE type_file.num5                                                                                                
    ...
    LET g_sql = "SELECT tc_pmj02,tc_pmj03,tc_pmj031,tc_pmj032,tc_pmj11,tc_pmj04,ima44,ima908,tc_pmj10,ecd02,ecbud02,",#No.FUN-930061 add ecd02 #add ecbud02 by guanyao160730
                "       tc_pmj13,tc_pmjicd14,tc_pmj05,tc_pmj06,tc_pmj06t,",  #FUN-560193  add ima44,ima908 #No.FUN-810017 add tc_pmj13   #FUN-A30072
                " tc_pmj07,tc_pmj07t,tc_pmj08,tc_pmj09,tc_pmj14",      #end No.FUN-550019    #No.FUN-9C0046 add tc_pmj14
#TQC-AB0025------------------mod-----------------str------------------
...
#               " AND tc_pmj10=ecd_file.ecd01 ",  #FUN-930061
                ...
                " AND ecb01(+) = tc_pmj03 AND ecb06(+) = nvl(tc_pmj10,'a') and nvl(tc_pmj11,'a')=ecb02(+)",     #add by guanyao160730
...
FUNCTION i255_bp(p_ud)
   ...
   DISPLAY ARRAY g_tc_pmj TO s_tc_pmj.* ATTRIBUTE(COUNT=g_rec_b,UNBUFFERED)
...
FUNCTION i255_b_g()
  ...
  DEFINE  l_pmhacti       LIKE pmh_file.pmhacti   #MOD-930327
    ...
    ELSE 
    #end----add by guanyao160525
    OPEN WINDOW i255b_w WITH FORM "apm/42f/cbmi255b"
       ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    CALL cl_ui_locale("cbmi255b")
      ...
      #MOD-C30260 -- add -- end
       ...
       SELECT COUNT(*) INTO g_cnt FROM tc_pmj_file
        WHERE tc_pmj01 = l_tc_pmj.tc_pmj01
          ...
          AND tc_pmj05 = l_tc_pmj.tc_pmj05
          AND tc_pmj10 = l_tc_pmj.tc_pmj10
          AND tc_pmj11 = l_tc_pmj.tc_pmj11
...
DEFINE p_cmd       LIKE type_file.chr1
    ...
    IF cl_null(l_c) OR l_c = 0 THEN 
       ...
       RETURN 
    END IF 
    OPEN WINDOW i255_w_2 WITH FORM "cpm/42f/ctc_pmi255_1"
       ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    CALL cl_ui_locale("ctc_pmi255_1")
    ...
    INSERT INTO tc_pmj_file(tc_pmj01,tc_pmj02,tc_pmj03,tc_pmj031,tc_pmj032,tc_pmj11,tc_pmj04,tc_pmj05,
                         ...
                         tc_pmj12,tc_pmj13,tc_pmjicd14,tc_pmjplant,tc_pmjlegal) 
